...
***Today's Progress***:
Back at it on this fine Monday.. got through the day with a few more hours of the Udacity "Intro to Statistics" course and Udacity's "SQL for Data Analysis" course.  Below are the links to each and some bullets on what I was able to cover.  Fortunately for me, both of these are just... about... DONE!
...
- SQL Advanced Joins (FULL OUTER JOIN, SELF JOIN)
...
***Today's Progress***:
Getting close to being through my second iteration of this recent coursework, including SQL and Statistics. Specifically, covered some of the Udacity's "Intro to Statistics" and "SQL for Data Analysis" courses. Below are the links to each and some bullets on what I was able to cover:
...
2. SQL: https://www.hackerrank.com/challenges/weather-observation-station-19

***Thoughts:***
Got quite a bit of progress in today and definitely feeling a bit exhausted.  I'll be at this for one more day, and then on to new material next week.  However, focusing so much effort on SQL and Statistics has made me MUCH stronger in each.  Feeling like I can much more comfortably handle complex problems in each of these domains.
...
***Today's Progress***:
Kept things moving today with Dataquest's "Decision Trees" course.  I started by finishing off the material on Applying Decision Trees, and then moved on to Random Forests, which are ensembles (collections) of Decision Trees.  Very, very powerful method that you see used very often in Data Science.  I've included in the "Link to Work" a very simple implementation of a Random Forest in Python.  Lastly, I got a Guided Project started on Predicting Bike Rentals, which will be an implementation of Random Forests from start (reading in data) to finish (prediction and model accuracy)
...
***Thoughts:***
Random Forests are a great approach to classification, and are very easy to implement in Python with the sklearn.RandomForestClassifier class.  Again, you can see my link below.  One thing I want to do in the coming weeks is take this approach and apply it to some work data to see if I can predict outcomes like the probability of quote to sale conversion.  I'm also excited for the guided project and applying some of these skills to a "friendly" data set.    I encourage anybody interested in making predictions to explore and find opportunities to apply Random Forests.
...
***Today's Progress***:
Didn't have a chance to post yesterday, as I was enjoying the weekend with friends, but did get a bit of studying in both yesterday and today.  Both days, I worked on Dataquest's project to predict loan default with Lending Club data, and I'm putting the project in Jupyter notebook so that I can both share it and refer back to it.  The general purpose is to work through an entire Machine Learning workflow to predict loan default, so I would expect it would be valuable to come back to time and again for other projects. I also spent a little bit more time doing housekeeping on my website and my LinkedIn profile. I plan on digging back into the Dataquest material tomorrow, and hoping I can get close to completing this Machine Learning project.
